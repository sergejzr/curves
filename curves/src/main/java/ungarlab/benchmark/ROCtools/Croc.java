...
/*
 ...
 Cold-Start Recommendations' 
  ...
  usage: java -Xmx450M ungarlab.benchmark.ROCtools.Croc infile outfile
...
public class Croc {
    ...
    */
    ...
    public Croc(String infile, String outfile) {
	...
	for (int person = 0; person < answer.length; person++) {
	    ...
	    IntComparator myCompare = (IntComparator) new MyComparator(prediction[person]);
	...
	Croc myObj = new Croc(argv[0],argv[1]);
	...
	public MyComparator(double[] prediction) {
